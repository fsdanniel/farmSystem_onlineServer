...
Este documento serve como o guia oficial para desenvolvedores do frontend do Sistema de Gestão de Granja. O projeto está num estado "feature-complete", com todos os módulos principais integrados e funcionais.
